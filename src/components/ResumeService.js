...
function ResumeService() {
  ...
  const handleSubmit = async (event) => {
    ...
    const requestBody = {
      prompt: `请针对${industry}行业的${position}职位，提供专业的求职辅导，并优化以下简历内容：${limitedResumeText}。请仔细检查拼写错误、语法错误和其他格式或文体问题。如果简历经历过于简略，你可以适当修改润色和进行补充扩展。在最后为简历提供点评和修改意见等反馈。请在编辑过程中遵循最佳实践和行业标准，不要包含任何个人意见或偏好，也不要杜撰简历中未提到的信息。不需要列出参考文献或者信息来源。`,
      max_tokens: 2500,
    };
